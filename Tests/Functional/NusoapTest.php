...
namespace NoiseLabs\Bundle\NuSOAPBundle\Tests\Functional;

class NusoapTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $client = new \nusoap_client('example.wsdl', true);
        $this->assertFalse($client->getError());
